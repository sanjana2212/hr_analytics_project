...
#barplot showing the proportion of promotions according to the dataset
...
print("20 most important variables according to XGBoost model")
...
#Accuracy of random forest model is 81.19% and XGBoost is 83.76%,which is slightly better.
```
